...
const Karyawan = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 p-4 pb-24 text-left">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-8 rounded-[3rem] shadow-xl border-4 border-slate-100 gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
          ...
          <button 
            ...
            className="bg-blue-600 hover:bg-slate-900 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl shadow-blue-100 flex items-center justify-center"
          >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-5xl rounded-[4rem] shadow-2xl p-10 border-4 border-blue-600 animate-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-10 text-left">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required className="w-full px-7 py-5 bg-slate-50 border-2 border-slate-100 rounded-3xl font-bold outline-none focus:border-blue-600 transition-all" value={formData.nama_lengkap} onChange={e => setFormData({...formData, nama_lengkap: e.target.value})} />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <select 
                      required
                      className="w-full px-7 py-5 bg-emerald-50 border-2 border-emerald-100 rounded-3xl font-bold outline-none focus:border-emerald-600 transition-all text-slate-800 appearance-none"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <input className="w-full px-7 py-5 bg-slate-50 border-2 border-slate-100 rounded-3xl font-bold outline-none focus:border-blue-600 transition-all" value={formData.nomor_wa} onChange={e => setFormData({...formData, nomor_wa: e.target.value})} />
                </div>
                <div className="space-y-2">
                  ...
                  <input type="email" className="w-full px-7 py-5 bg-slate-50 border-2 border-slate-100 rounded-3xl font-bold outline-none focus:border-blue-600 transition-all" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} />
                </div>
                <div className="space-y-2">
                  ...
                  <input className="w-full px-7 py-5 bg-slate-50 border-2 border-slate-200 rounded-3xl font-black outline-none focus:border-blue-600 transition-all text-blue-600" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} />
                </div>
              </div>

              <button type="submit" disabled={loading} className="w-full bg-blue-600 text-white py-7 rounded-[2.5rem] font-black uppercase text-xs tracking-[0.2em] shadow-2xl hover:bg-slate-900 transition-all flex items-center justify-center active:scale-95 disabled:bg-slate-200"
              >
